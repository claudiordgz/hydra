...
(function() {
  ...
  formatBlog = function() {
    if ($('.post').length && ($('body').is('.post-template') || $('body').attr('data-post-mode') === 'multimedia' && ($('body').is('.home-template') || $('body').is('.archive-template') || $('body').is('.tag-template')))) {
      $('.post').imagesLoaded(function() {
        $('.post:not(.formated)').each(function() {
          var $audioEl, $audioPlayer, $backgroundEl, $line, $playback, $postContent, $postHeader, $section, $this, $video, $videoEl, $videoPlayback, $vimeoVideoEl, apiUrl, bg_url, regExp, regResult, soundcloudUrl, videoData, videoUrl, vimeoId, vimeoUrl, vimeoVideoUrl, waveformColor, youtubeId;
          $this = $(this);
          ...
          if ($postContent.has('a[href*="youtube.com"]').length) {
            ...
            $.getJSON(apiUrl, function(data) {
              ...
              var regExp;
              var $audioEl;
              var $audioPlayer, $playback, $section, waveformColorOptions;
              if (data.id) {
                ...
                SC.get('/tracks/' + data.id, function(track) {
                  var onfinishOptions, streamOptions, waveform;
